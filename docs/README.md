...
| пользователь		  	  | [Регистрация и авторизация](#registration_and_authorization)|
| пользователь			  | [Игра дурак](#fool_game)|
| пользователь            | [Добавление в друзья другого пользователя](#add_friend)|
| пользователь            | [Создание лобби и приглашение игроков](#create_lobby_and_invite_players)|
| пользователь            | [Настройка профиля](#profile_settings)|
